...
; *** SetupLdr messages
SetupLdrStartupMessage=%1 wird nun installiert. Möchten Sie fortfahren?
...
SetupFileCorrupt=Die Setup-Datei ist beschädigt. Besorgen Sie sich bitte eine neue Kopie des Programms.
SetupFileCorruptOrWrongVer=Die Setup-Datei ist beschädigt oder inkompatibel zu dieser Version des Setups. Bitte beheben Sie das Problem, oder besorgen Sie sich eine neue Kopie des Programms.
...
AboutSetupMessage=%1 Version %2%n%3%n%n%1-Projektseite:%n%4
AboutSetupNote=
TranslatorNote=Modifikation der deutschen Übersetzung by René Linke (rene.linke@blindzeln.de).
...
LicenseLabel=Lesen Sie bitte nachstehend die wichtigen Informationen bevor Sie fortfahren.
...
LicenseAccepted=Ich a&kzeptiere die Vereinbarung
LicenseNotAccepted=Ich &lehne die Vereinbarung ab

; *** "Information" wizard pages
WizardInfoBefore=Information
InfoBeforeLabel=Lesen Sie bitte nachstehend die wichtigen Informationen bevor Sie fortfahren.
InfoBeforeClickLabel=Klicken Sie auf "Weiter", sobald Sie bereit sind mit dem Setup fortzufahren.
WizardInfoAfter=Information
InfoAfterLabel=Lesen Sie bitte nachstehend die wichtigen Informationen bevor Sie fortfahren.
